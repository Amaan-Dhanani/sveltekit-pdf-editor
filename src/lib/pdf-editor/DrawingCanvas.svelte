...
<div
    ...
    bind:this={canvas}
    class="drawing-input-layer absolute left-0 top-0 h-full w-full cursor-crosshair select-none touch-none overscroll-contain [-webkit-touch-callout:none]"
    oncontextmenu={(e) => e.preventDefault()}
>
    <canvas 
        bind:this={previewCanvas} 
        class="drawing-preview-canvas pointer-events-none h-full w-full touch-none select-none overscroll-contain [-webkit-touch-callout:none]"
    ></canvas>
</div>